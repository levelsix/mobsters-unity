...
public class UIGrid : UIWidgetContainer
{
	...
	[HideInInspector][SerializeField] protected bool sorted = false;
	...
	static public int SortByName (Transform a, Transform b) { return string.Compare(a.name, b.name); }//Kenny replaced string.compare with MSNaturalSortObject.Compare
