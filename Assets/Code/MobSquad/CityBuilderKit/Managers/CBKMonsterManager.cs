...
public class CBKMonsterManager : MonoBehaviour {
	...
	public void AddToHealQueue(PZMonster monster)
	{
		...
		if (CBKResourceManager.instance.Spend(ResourceType.CASH, monster.healCost, delegate{AddToHealQueue(monster);}))
		{
	...
	public void AddToEnhanceQueue(PZMonster monster)
	{
		...
		else if (CBKResourceManager.instance.Spend(ResourceType.OIL, monster.enhanceXP, delegate{AddToEnhanceQueue(monster);}))
		{
			if (enhancementFeeders.Count == 0)
			{
