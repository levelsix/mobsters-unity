...
public static class UMQDeserializer {
	...
	static Dictionary<EventProtocolResponse, Type> dict = new Dictionary<EventProtocolResponse, Type>()
	{
		...
		{EventProtocolResponse.S_CHANGE_CLAN_SETTINGS_EVENT, typeof(ChangeClanSettingsResponseProto)},
		...
		{EventProtocolResponse.S_SPAWN_OBSTACLE_EVENT, typeof(SpawnObstacleResponseProto)},
		...
		{EventProtocolResponse.S_ENHANCE_MONSTER_EVENT, typeof(EnhanceMonsterResponseProto)}
	};
