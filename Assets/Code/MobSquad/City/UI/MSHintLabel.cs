...
public class MSHintLabel : MonoBehaviour {
	...
	string[] hints = 
	{
		...
		"You need 2 max level x_characters to evolve to their next form.",
		...
		"In multiplayer battles x_characters always start at full health.",
		"Join a Squad to to chat and play with others from around the world.",
		"Night and Day x_characters are powerful against each other.",
		...
		"Upgrade or build more hospitals to increase the number of x_characters they hold.",
		"You can play single player missions without losing your shield.",
		"Upgrade your storages to increase your max Cash and Oil.",
		"Enhancing and evolving x_characters is important for crafting a strong team.",
		"Find all of a x_character’s pieces? See how long it will take to complete in your Team Center.",
		"Tap on the heart in the upper left of a x_character’s info page to make it your avatar.",
	...
	void OnEnable()
	{
		...
		label.text.Replace("x_character", MONSTER_NAME);
	}
}
