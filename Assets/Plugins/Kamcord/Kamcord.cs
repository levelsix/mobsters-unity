...
/// Android Version: 1.3.3 (2014-06-04)
//////////////////////////////////////////////////////////////////
...
#pragma warning disable
	...
	// For Andorid, add calls to white/blacklist specific devices here:
	...
	public class Implementation
	{
		...
		public virtual void SetShareTargets(ShareTarget target1,
		                                    ShareTarget target2,
		                                    ShareTarget target3,
		                                    ShareTarget target4)
		{
		...
		public virtual void SetDeveloperMetadata (MetadataType metadataType,
		                                           string displayKey,
		                                           string displayValue)
		{
		}

		public virtual void SetDeveloperMetadataWithNumericValue (MetadataType metadataType,
		                                                           string displayKey,
		                                                           string displayValue,
		                                                           double numericValue)
		{
	...
	{
		// kamcordEnabled_ must be set true before calling this function,
	...
	public static void SetShareTargets(ShareTarget target1,
	                                   ShareTarget target2,
	                                   ShareTarget target3,
	                                   ShareTarget target4)
	{
	...
	public static void SetDeveloperMetadata (MetadataType metadataType,
	                                         string displayKey,
	                                         string displayValue)
	{
	...
	public static void SetDeveloperMetadataWithNumericValue (MetadataType metadataType,
	                                                         string displayKey,
	                                                         string displayValue,
	                                                         double numericValue)
	{
	...
	void Awake()
	{
		...
		// If the dev sets the flag "Enable Kamcord", in the prefab settings,
		// here we set the static boolean kamcordEnabled_ to true, future calls
		// to implementation() check kamcordEnabled before returning either an
		// empty implementation or the platform specific one.
